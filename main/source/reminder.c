...
void remind_entry_init(void)
{
    ...
    hour_entry = lv_textarea_create(station_info_disp);
    ...
    min_entry = lv_textarea_create(station_info_disp);
    ...
    remind_time_entry = lv_textarea_create(station_info_disp);
    ...
    cancel_button = lv_btn_create(station_info_disp);
    ...
    add_button = lv_btn_create(station_info_disp);
...
void reminder_set_show(Station *sta)
{
    ...
    lv_obj_t * title = lv_label_create(station_info_disp);
    lv_obj_set_pos(title, 30, 30);
    lv_obj_set_style_text_font(title, &heiti_24, 0);
    lv_label_set_text(title, "添加提醒");

    lv_obj_t * discrip = lv_label_create(station_info_disp);
    ...
    lv_obj_t * sta_name = lv_label_create(station_info_disp);
    ...
    lv_obj_t *line_num = lv_label_create(station_info_disp);
    ...
    lv_obj_t * direc = lv_label_create(station_info_disp);
