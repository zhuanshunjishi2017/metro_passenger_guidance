...
const Station line_1[32] = {
    ...
    {13, "汉西一路", "hanxiyilu",         14, 16, 0, -1, 1, 0},
    {14, "宗关", "zongguan",              15, 17, 3, -1, 0, 1},
...
const Station line_2[38] = {   
    ...
    {6, "宏图大道", "hongtudadao",            20, 6, 3, 0, 1, 1},
    ...
    {21, "洪山广场", "hongshanguangchang",    27, 21, 4, 1, 1, 1},
    {22, "中南路", "zhongnanlu",              26, 22, 4,-1, 1, 1},
...
const Station line_3[24] = {
    {1, "沌阳大道", "zhuanyangdadao",         5, 27, 0, 1, 1, 1},
    {2, "东风公司", "dongfenggongsi",         6, 26, 0, 1, 1, 0},
    {3, "体育中心", "tiyuzhongxin",           7, 25, 0, 1, 1, 0},
    {4, "三角湖", "sanjiaohu",                8, 24, 0, 1, 1, 0},
    {5, "汉阳客运站", "hanyangkeyunzhan",    9, 23, 0, 1, 1, 0},
    {6, "四新大道", "sixindadao",            10, 22, 0, 1, 1, 0},
    {7, "陶家岭", "taojialing",              11, 21, 0, 1, 1, 0},
    {8, "龙阳村", "longyangcun",             12, 20, 0, 1, 1, 0},
    {9, "王家湾", "wangjiawan",              13, 19, 4, 1, 0, 0},
    {10, "宗关", "zongguan",                 15, 17,-1,-1, 0, 1},
    {11, "双墩", "shuangdun",                15, 15, 0,-1,-1, 1},
    {12, "武汉商务区", "wuhanshangwuqu",     16, 14, 0,-1,-1, 0},
    {13, "云飞路", "yunfeilu",               17, 13, 0,-1,-1, 0},
    {14, "范湖", "fanhu",                    18, 12,-2,-1,-1, 1},
    ...
    {24, "宏图大道", "hongtudadao",          20, 6, -1, 0, 1, 1}
};
const Station line_4[37] = {
    {1, "柏林", "bailin",                    1, 17, 0,-1, 0, 1},
    {2, "新庙村", "xinmiaocun",              2, 17, 0, 0,-1, 0},
    {3, "临嶂大道", "linzhangdadao",         3, 17, 0, 0, 1, 0},
    {4, "蔡甸广场", "caidianguangchang",     4, 17, 0, 0,-1, 1},
    {5, "凤凰路", "fenghuanglu",             5, 18, 0,-1, 1, 0},
    {6, "新农", "xinnong",                   6, 19, 0,-1, 1, 0},
    {7, "知音", "zhiyin",                    7, 20, 0,-1, 1, 1},
    {8, "集贤", "jixian",                    8, 20, 0, 0,-1, 0},
    {9, "新天", "xintian",                   9, 20, 0, 1, 1, 1},
    {10, "黄金口", "huangjinkou",            9, 19, 0,-1, -1, 1},
    {11, "孟家铺", "mengjiapub",             10, 19, 0, 0,-1, 0},
    {12, "永安堂", "yongantang",            11, 19, 0, 0, 1, 0},
    {13, "玉龙路", "yulonglu",              12, 19, 0, 0,-1, 0},
    {14, "王家湾", "wangjiawan",            13, 19,-3, 1, 0, 1},
    {15, "十里铺", "shilipu",               14, 20, 0, 0, 1, 1},
    {16, "七里庙", "qilimiao",              15, 20, 0, 0,-1, 0},
    {17, "五里墩", "wulidun",               16, 20, 0, 0, 1, 0},
    {18, "汉阳火车站", "hanyanghuochezhan", 17, 20, 0, 0,-1, 0},
    {19, "钟家村", "zhongjiacun",           18, 20, 0, 0, 1, 0},
    {20, "拦江路", "lanjianglu",            19, 20, 0, 0,-1, 1},
    ...
    {25, "中南路", "zhongnanlu",            26, 22,-2,-1, 1, 1},
    {26, "洪山广场", "hongshanguangchang",  27, 21,-2, 1, 1, 1},
...
const MetroLine metro_lines[4] = {
    {line_1, 32, COLOR_LINE1, 6 , 1},
    {line_2, 38, COLOR_LINE2, 17, 2},
