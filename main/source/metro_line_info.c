...
const Station line_4[37] = {
    ...
    {14, "王家湾", "wangjiawan",            13, 19,-1, 1, 0, 1},
    ...
    {25, "中南路", "zhongnanlu",            26, 22,-1,-1, 1, 1},
    {26, "洪山广场", "hongshanguangchang",  27, 21,-1, 1, 1, 1},
