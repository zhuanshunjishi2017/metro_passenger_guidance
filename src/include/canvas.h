...
extern const lv_img_dsc_t bell_blue_pic, bell_white_pic;
extern const lv_img_dsc_t line_blue_pic, line_white_pic;
extern const lv_img_dsc_t location_end, location_start, location;
extern const lv_img_dsc_t map_blue_pic, map_white_pic;
extern const lv_img_dsc_t logo_pic, train, trash_bin;
